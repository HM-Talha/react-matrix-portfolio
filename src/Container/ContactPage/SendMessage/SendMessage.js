            ...
            <div className="contact-page  p-0">
                <div className="container  p-0">
                    <div className="section-title text-center ">
                        <span className="section_tagline p-0">
                            Contact With US
                        </span>
                        <h2 className=" section-title_title text-dark font-weight-bold">Write us a message</h2>
                        <p className="text1">
                            Do you have any questions? Requests? Ideas? Or maybe you simply want to chat with us
                            to get to know us better? Whatever the reason, everything you need to contact us:)
                        </p>
                    </div>
                </div>
            </div>
