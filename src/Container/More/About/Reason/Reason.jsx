    ...
    <section className="container reasonParent">
      ...
      <div  className="reasonChild2">
        ...
        <p>
          ...
          Asinlabs believes in reinventing itself every few years, which is why
          we have grown over the past four decades. We have created a culture
          that allows us to foster innovation in its broader sense and focus on
          idea generation. .
        </p>
        </section>
        <section>
        ...
        <p>
          <i className="fa-solid fa-check checkLogo" /> Professionally managed
          and supported
        </p>
        <p>
          <i className="fa-solid fa-check checkLogo" /> Proficient in google,
          and most productivity suites
        </p>
      </div>
        </section>
      </div>
